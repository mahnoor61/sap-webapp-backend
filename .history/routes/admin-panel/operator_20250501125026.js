...
const {
  ...
  updateIssueForMachine,
  // updateTransferedQuantity,,
  addIssueForMachine,
  addCompletedQuantity,
  saveDownTime,
  addWastedQuantity,
  updateStatus,
  getProductionTime,
  updateDownTime,
  getFirstRouteForIssueToPostDataIntoSap,
  remainingQty,
  getCompletedQtyOfPreviousRoute,
...
router.post(
  "/update/recieved-by-operator/:id",
  middleware,
  updateRecievedByOperator
);
...
router.post(
  "/get/completed-quantity/previous-route",
  middleware,
  getCompletedQtyOfPreviousRoute
);
...
router.post(
  "/save/prodTime/on-stop",
  middleware,
  uploadMiddleware("production").single("images"),
  updateStopProductionTime
);

router.get("/get/last/route/:id", middleware, getLastRouteOfProductionOrder);
router.get("/get/first/route/:id", middleware, getLastRouteOfProductionOrder);
